...
function Staff({ id }: StaffProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex md:flex-col gap-6 items-start justify-center bg-[#F0F0F0] md:w-[82%] w-[95%] mx-auto rounded-3xl py-10 px-4"
        data-aos="fade"
      ...
      >
        ...
        <div className="md:flex hidden mx-auto gap-6 justify-center w-full">
          <CardStaff
        ...
        <div className="md:flex hidden flex-wrap gap-12 justify-center w-full">
          <CardStaff
            img={NicolasCastano}
            empleado
